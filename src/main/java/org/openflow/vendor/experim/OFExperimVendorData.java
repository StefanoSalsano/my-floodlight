...
/**
 * Base class for vendor data corresponding to a OpenMsg vendor extension.
 * OpenMsg vendor data always starts with a 4-byte integer data type value.
 * 
 */
...
public class OFExperimVendorData implements OFVendorData {
     ...
     */
    public OFExperimVendorData() {
    }
    
    /**
     * Contruct OpenMsg vendor data with the specified data type
     * @param dataType the data type value at the beginning of the vendor data.
     */
    public OFExperimVendorData(int dataType) {
